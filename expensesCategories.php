...
<body>
	...
	<header>
		...
		<nav class="navbar navbar-light bg-secondary navbar-expand-lg">
            ...
            <div id=container>
                <div id= tableTitle> Tabela katergorii wydatków </div>
                <div id= addNew data-toggle="modal" data-target="#AddNewExpenseCategoryModal"><a href="#" class=addLink title="Dodaj nową kategorię" > + Dodaj</a></div>
