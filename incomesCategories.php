...
<body>
	...
	<header>
		...
		<nav class="navbar navbar-light bg-secondary navbar-expand-lg">
            ...
            <div id=container>
                <div id= tableTitle> Tabela katergorii przychodów </div>
                <div id= addNew data-toggle="modal" data-target="#AddNewIncomeCategoryModal"><a href="#" class=addLink title="Dodaj nową kategorię" > + Dodaj</a></div>
...
<div class="modal fade" id="AddNewIncomeCategoryModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="addIncomeCategory.php" method="post">
            <div class="modal-body">
            <input type="text" name="newIncomeCategory" placeholder="Nazwa katergorii" /> <br/>
