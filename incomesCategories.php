        ...
        <table class="table table-sm table-hover table-dark">
            <?php
                ...
                else
                {
                    ...
                    <thead>
                        <tr>
                            <th><center>Tabela kategorii przychodów</center></th>
                            <th><div id= addNew data-toggle="modal" data-target="#AddNewIncomeCategoryModal"><a href="#" class=addLink title="Dodaj nową kategorię" > + Dodaj</a></div></th>
