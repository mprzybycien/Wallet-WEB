		...
		<nav class="navbar navbar-light bg-secondary navbar-expand-lg">
			...
			<div class="collapse navbar-collapse" id="mainmenu">
				...
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item dropdown ">
                        <a class="nav-link" href="expensesCategories.php"> Kategorie wydatków </a>
					</li>
				</ul>
            </div>
		</nav>
            ...
            <div id=container>
                <div id= tableTitle> Tabela katergorii metod płatności </div>
                <div id= addNew data-toggle="modal" data-target="#AddNewMethodCategoryModal"><a href="#" class=addLink title="Dodaj nową kategorię" > + Dodaj</a></div>
                ...
                /*
                <div class=categoryName> Kategoria  </div>
...
<!-- MODAL kategorii metod płatności -->   
    
<div class="modal fade" id="AddNewMethodCategoryModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="addMethodCategory.php" method="post">
            <div class="modal-body">
            <input type="text" name="newMethodCategory" placeholder="Nazwa katergorii" /> <br/>
